job_descriptions = [
    {
        ...
        'responsibilities': [
            ...
            " Have to take full ownership of a project to ensure on-time delivery of working software. ",
            " Adapting and Implementing new technologies and frameworks. ",
    ...
    },
    {
        ...
        'responsibilities': [
            "Must have a minimum of 4 years of solid experience in .Net.",
    ...
    },
    {
        ...
        'responsibilities': [
            ...
            "    Design, build and maintain high performance, reusable, and reliable application in                         cluster. ",
            "  Ensure the best possible performance, quality, and responsiveness of the application\n ",
            "  Identify and correct bottlenecks and fix bugs across the production and development environments.\n ",
            "  Help maintain code quality, organization, and automation in the development and    deployment life cycle. ",
            "  Design and implement complex DevOps pipelines and work in “code as configurations” fashion."
        ],
        'requirements': [
            "At least 3-6 years of experience in production-grade DevOps engineering.",
            ...
            "  Working experience of different K8s tools like helm, dashboard, kompose, Prometheus, envoy, weave etc.",
            ...
            " Proven experience of handling large scale NoSQL database (Cassandra, MongoDB, Redis). \n\n    ",
            ...
            " Working knowledge about API Management, API Proxies (kong/gravity, etc.), API Policies and API routing."
        ],
